#' Summarize data
#' 
#' Determine count, mean, standard deviation, standard error of the mean, and confidence interval (default 95%).
#' 
#' @param data Input \code{data.frame}
#' @param measurevar Column with variable to be summarized
#' @param groupvars Vector of column names that contain grouping variables
